...
use App\Http\Controllers\ProfileCoRoute::get('/users/export/pdf', 'App\Http\Controllers\ExportController@exportAllUsersPdf')->name('users.export.pdf');    Route::get('/users', [UserController::class, 'index'])->name('users.index');troller;
