...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/users/export/pdf', 'App\Http\Controllers\ExportController@exportAllUsersPdf')->name('users.export.pdf');
    ...
    Route::get('/employees', 'App\Http\Controllers\UserController@showAllEmployees')->name('employees.all');
