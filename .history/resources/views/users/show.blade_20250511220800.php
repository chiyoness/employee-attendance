...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex">            <a href="{{ route('users.index') }}" class="btn btn-outline-primary me-2">
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 text-center mb-4">                    @if($user->image)
                        <img src="../../../storage/{{ $user->image }}" class="rounded-circle img-fluid mb-3" style="max-width: 150px; height: auto;" alt="{{ $user->name }}">
                    @else
