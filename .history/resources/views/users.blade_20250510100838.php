        ...
        <div class="d-flex">
            <a href="{{ route('dashboard') }}" class="btn btn-outline-primary me-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{ route('employees.export.excel') }}">Excel (Server-side)</a></li>
                    <li><a class="dropdown-item" href="{{ route('employees.export.csv') }}">CSV (Server-side)</a></li>
                    <li><a class="dropdown-item" href="{{ route('employees.export.pdf') }}">PDF (Server-side)</a></li>
                </ul>
            </div>
        </div>
    </div>
